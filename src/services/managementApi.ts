...
function normalizeProject(item: Record<string, unknown>): ManagedProject {
  ...
  const completionLabels: Record<string, ManagedProject['completionNode']> = { annotation: '标注', quality_check: '质检', review: '审核', acceptance: '验收' }
