  ...
  return (
    <main className="login-page">
      ...
      <section className="login-card" aria-label="登录">
        <div className="login-card-title"><span className="login-title-icon"><KeyRound size={22} /></span><div><h2>欢迎登录</h2><p>登录 VLA Forge 开始数据生产作业</p></div></div>
      ...
      <footer className="login-footer">© 2026 VLA Forge All Rights Reserved</footer>
